...
rule PCB (clearance 0.1524 (type buried_via_gap))
rule PCB (clearance 0.1524 (type wire_wire))
rule PCB (clearance 0.1524 (type wire_smd))
rule PCB (clearance 0.1524 (type wire_pin))
rule PCB (clearance 0.1524 (type wire_via))
rule PCB (clearance 0.1524 (type smd_smd))
rule PCB (clearance 0.1524 (type smd_pin))
rule PCB (clearance 0.1524 (type smd_via))
rule PCB (clearance 0.1524 (type pin_pin))
rule PCB (clearance 0.1524 (type pin_via))
rule PCB (clearance 0.1524 (type via_via))
rule PCB (clearance 0.1524 (type test_test))
rule PCB (clearance 0.1524 (type test_wire))
rule PCB (clearance 0.1524 (type test_smd))
rule PCB (clearance 0.1524 (type test_pin))
rule PCB (clearance 0.1524 (type test_via))
...
rule PCB (clearance 0.1524 (type microvia_microvia))
set microvia_microvia on
rule PCB (clearance 0.1524 (type microvia_thrupin))
set microvia_thrupin on
rule PCB (clearance 0.1524 (type microvia_smdpin))
set microvia_smdpin on
rule PCB (clearance 0.1524 (type microvia_thruvia))
set microvia_thruvia on
rule PCB (clearance 0.1524 (type microvia_bbvia))
set microvia_bbvia on
rule PCB (clearance 0.1524 (type microvia_wire))
set microvia_wire on
rule PCB (clearance 0.1524 (type bbvia_bbvia))
set bbvia_bbvia on
rule PCB (clearance 0.1524 (type microvia_testpin))
set microvia_testpin on
rule PCB (clearance 0.1524 (type bbvia_thrupin))
set bbvia_thrupin on
rule PCB (clearance 0.1524 (type microvia_testvia))
set microvia_testvia on
rule PCB (clearance 0.1524 (type bbvia_smdpin))
set bbvia_smdpin on
rule PCB (clearance 0.1524 (type microvia_bondpad))
set microvia_bondpad on
rule PCB (clearance 0.1524 (type bbvia_thruvia))
set bbvia_thruvia on
rule PCB (clearance 0.1524 (type microvia_area))
set microvia_area on
rule PCB (clearance 0.1524 (type bbvia_wire))
set bbvia_wire on
rule PCB (clearance 0.2032 (type nhole_pin))
set nhole_pin off
rule PCB (clearance 0.2032 (type nhole_via))
set nhole_via off
rule PCB (clearance 0.1524 (type bbvia_area))
set bbvia_area on
...
set mhole_pin off
rule PCB (clearance 0.1524 (type bbvia_testpin))
set bbvia_testpin on
rule PCB (clearance 0 (type mhole_via))
set mhole_via off
rule PCB (clearance 0.1524 (type bbvia_testvia))
...
set mhole_mhole off
rule PCB (clearance 0.1524 (type bbvia_bondpad))
